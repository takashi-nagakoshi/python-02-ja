def apply_discount(
    ...
    return[(elem["name"],calculate_price(elem["price"]),
                )
...
# 関数の呼び出し
result = apply_discount(products, minimum_price, discount_rate)
...
# # 関数の呼び出し
result2 = apply_discount(products2, minimum_price, discount_rate)
